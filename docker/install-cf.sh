...
if command -v git &> /dev/null; then
    if [ -d ".git" ]; then
        ...
        git clone https://github.ygking.top/github.com/tooplick/qqmusic-web.git .
    fi
    echo "项目文件下载完成"
else
    ...
    # 下载项目zip文件
    echo "wget项目文件..."
    wget -O qqmusic_web.zip http://github.ygking.top/github.com/tooplick/qqmusic-web/archive/main.zip
